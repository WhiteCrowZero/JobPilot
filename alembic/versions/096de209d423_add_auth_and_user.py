...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('active', 'disabled', 'deleted', name='user_status', native_enum=False, create_constraint=True, length=20), server_default='active', nullable=False),
    ...
    sa.Column('provider', sa.Enum('email', 'phone', 'github', 'google', name='auth_provider', native_enum=False, create_constraint=True, length=30), nullable=False),
    ...
    op.create_index('ix_auth_identities_provider_email', 'auth_identities', ['provider', 'provider_email'], unique=False)
    ...
    op.create_index('ix_auth_identities_user_provider', 'auth_identities', ['user_id', 'provider'], unique=False)
    ...
    op.create_table('auth_password_credentials',
